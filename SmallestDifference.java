...
these two numbers, wth the number from the first array in the 
first position. No. that the absolute difference of two integers 
is the distance between them on the real number line. For example, 
the absolute difference of -5 and 5 is 10, and the absolute 
difference of -5 and -401. 
